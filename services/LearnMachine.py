...
# הגדרת נתיב לתמונות
train_dir = r"H:\pictures\divide"
validation_dir = r"H:\pictures\divide"
...
# --- 1. נתיבי הנתונים ---
train_dir = r"H:\pictures\divide"  # נתיב לתיקיית אימון
validation_dir = r"H:\pictures\divide"  # נתיב לתיקיית אימות
output_dir = r"H:\pictures\sorted_images"  # תיקיות למיון אוטומטי
...
# --- 4. שימוש ב-ResNet18 עם משקלים מקומיים ---
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
num_classes = len(train_dataset.classes)  # כמות הקטגוריות

# טוען משקלים מקומיים
weights_path = r"C:\Users\fisherm\.cache\torch\hub\checkpoints\resnet18-f37072fd.pth"
model = models.resnet18(weights=None)  # בלי הורדה
model.load_state_dict(torch.load(weights_path))  # טען משקלים מהקובץ
model.fc = nn.Linear(model.fc.in_features, num_classes)  # classifier אחרון
...
# --- דוגמה לשימוש ---
# sort_images(r"H:\pictures\unsorted", model, device, output_dir)
"""